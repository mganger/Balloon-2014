...
public:
	...
	{
		return AcquireAveragedSamplePressure(NUM_SAMP_FOR_AVG);
	} 
...
protected:
    ...
    virtual int32_t AcquireAveragedSamplePressure(const uint8_t nSamples) = 0;
...
*/
    ...
    virtual int32_t AcquireAveragedSamplePressure(const uint8_t nSamples)
    {
        int64_t pressAccum = 0;
